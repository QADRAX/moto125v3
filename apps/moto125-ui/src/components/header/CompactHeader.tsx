...
export default async function CompactHeader() {
  ...
  return (
    <div className="compact-header bg-white border-b-3 border-primary" aria-hidden="true">
      <div className="mx-auto max-w-page px-4 sm:px-6">
        {/* Siempre en la misma línea (desktop only) */}
        <div className="h-12 hidden sm:flex items-center gap-4">
          <HeaderBrand siteName={siteName} logoUrl={logoUrl} alt={cfg?.logo?.alternativeText} size="sm" />
