...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    articleType: Schema.Attribute.Relation<
      'manyToOne',
      'api::article-type.article-type'
    >;
    authorAction: Schema.Attribute.String;
    authorPhotos: Schema.Attribute.String;
    authorText: Schema.Attribute.String;
    content: Schema.Attribute.DynamicZone<
      [
        'article-content.text-content',
        'article-content.image-grid-content',
        'article-content.prestaciones',
    ...
    publishedAt: Schema.Attribute.DateTime;
    relatedCompanies: Schema.Attribute.Relation<
      'manyToMany',
      'api::company.company'
    >;
    relatedMotos: Schema.Attribute.Relation<'manyToMany', 'api::moto.moto'>;
    slug: Schema.Attribute.UID & Schema.Attribute.Required;
    tags: Schema.Attribute.Component<'list.tag-list', true>;
...
export interface ApiMotoClassMotoClass extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::moto-class.moto-class'
    > &
      Schema.Attribute.Private;
    motoTypes: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiMotoTypeMotoType extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    motoClass: Schema.Attribute.Relation<
      'manyToOne',
      'api::moto-class.moto-class'
    >;
    motos: Schema.Attribute.Relation<'oneToMany', 'api::moto.moto'>;
...
export interface ApiMotoMoto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    moto125Id: Schema.Attribute.UID & Schema.Attribute.Required;
    motoType: Schema.Attribute.Relation<
      'manyToOne',
      'api::moto-type.moto-type'
    >;
